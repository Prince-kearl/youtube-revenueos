...
const sheetVariants = cva(
  "ios26-glass fixed z-50 gap-4 bg-background p-6 shadow-lg backdrop-blur-xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
