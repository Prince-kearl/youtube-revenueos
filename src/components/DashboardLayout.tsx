...
function HelpSheet({ open, onOpenChange }: { open: boolean; onOpenChange: (v: boolean) => void }) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        className="bottom-3 right-3 top-auto flex h-auto max-h-[calc(100%-1.5rem)] w-[calc(100%-1.5rem)] flex-col gap-0 rounded-2xl border p-5 shadow-2xl sm:bottom-4 sm:right-4 sm:max-h-[calc(100%-2rem)] sm:w-full sm:max-w-sm"
        closeClassName="rounded-full"
      >
