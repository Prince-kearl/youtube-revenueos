...
export function AdminNav({ active, onSelect }: { active: AdminSection; onSelect: (s: AdminSection) => void }) {
  ...
  return (
    <>
      ...
      <nav aria-label="Admin" className={cn("fixed bottom-4 left-1/2 z-50 w-fit max-w-[calc(100%_-_1.5rem)] -translate-x-1/2 lg:hidden print:hidden", keyboardOpen && "hidden")} style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
