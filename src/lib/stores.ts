...
const seedNotifs = (): Notification[] => [
  {
    ...
    icon: "message",
    color: "purple",
    title: "TechCorp deal expires in 3 days",
    time: "Now",
    read: false,
    pinned: false,
    archived: false,
  ...
  },
  {
    ...
    icon: "dollar",
    color: "amber",
    title: "AdSense: $4,820 payout incoming",
    time: "2h",
    read: false,
    pinned: false,
    archived: false,
  },
  {
    ...
    icon: "alert",
    color: "red",
    title: "CPM drop detected — 3 videos",
    time: "3h",
    read: true,
    pinned: false,
    archived: false,
  },
  {
    ...
    icon: "zap",
    color: "purple",
    title: "AI optimization ready for 7 videos",
    time: "5h",
    read: true,
    pinned: false,
    archived: false,
  },
  {
    ...
    icon: "clock",
    color: "blue",
    title: "HealthBrand follow-up scheduled",
    time: "6h",
    read: true,
    pinned: false,
    archived: false,
